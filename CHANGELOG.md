...
- Improved performance of fetching temporary S3 credentials (roughly 4x speedup)
  ...
  ([#1182](https://github.com/earthaccess-dev/earthaccess/issues/1182)) (@chuckwondo)
- `open_virtual_datasets` now accepts `load=False` to avoid materializing indexes
  ...
  Fixes ([#1185](http://github.com/earthaccess-dev/earthaccess/issues/1185)) (@betolink)

### Added

- Added methods `doi` and `citation` to `DataCollection` class.
  ([#203](https://github.com/earthaccess-dev/earthaccess/issues/203))
  (@Sherwin-14, @chuckwondo)
- Added property `__geo_interface__` to `DataGranule` class.
  ([#1179](https://github.com/earthaccess-dev/earthaccess/pull/1179)) (@s-kganz)
...
- Ignore environment variables `EARTHDATA_USERNAME` and `EARTHDATA_PASSWORD`
  ...
  ([#1121](https://github.com/earthaccess-dev/earthaccess/issues/1121)) (@chuckwondo)
- Use only specified login strategy to attempt login, when strategy other than
  "all" is specified ([#945](https://github.com/earthaccess-dev/earthaccess/issues/945))
  (@chuckwondo)
- Fix undesirable pre-commit changes when running on Windows
  ([#1143](https://github.com/earthaccess-dev/earthaccess/issues/1143)) (@ana-sher)
- No longer erroneously strip authorization header for valid hosts
  ([#1130](https://github.com/earthaccess-dev/earthaccess/issues/1130)) (@chuckwondo)
- Fix `AttributeError` raised by `Auth.get_s3_credentials` when
  ...
  ([#1181](https://github.com/earthaccess-dev/earthaccess/issues/1181)) (@chuckwondo)
...
- Obstore and VirtualiZarr should not be required
  ([#1097](https://github.com/earthaccess-dev/earthaccess/issues/1097))
...
- Populated glossary section under USER-REFERENCE.
  ([#1027](https://github.com/earthaccess-dev/earthaccess/issues/1027))
...
- Change default cache behavior in fsspec from `readahead` to `blockcache`.
  ...
  ([#771](https://github.com/earthaccess-dev/earthaccess/discussions/771))
  ([@betolink](https://github.com/betolink))
- Add `show_progress` argument to `earthaccess.download()` to let the user
  ...
  ([#1065](https://github.com/earthaccess-dev/earthaccess/pull/1065))
  ([@Sherwin-14](https://github.com/Sherwin-14))
- Updated bug and triage label names in bug Issue template.
  ([#998](https://github.com/earthaccess-dev/earthaccess/pull/998))
  ([@asteiker](https://github.com/asteiker))
- `download` now raises `DownloadFailure` exception on failure.
  ([#612](https://github.com/earthaccess-dev/earthaccess/issues/612))
  ([@Sherwin-14](https://github.com/Sherwin-14))
- `GESDISC` should be `GES_DISC` in docstrings.
  ([#1037](https://github.com/earthaccess-dev/earthaccess/issues/1037))
...
- `open_virtual_mfdataset` now uses `virtualizarr` v2, and `obstore` in place of
  ...
  ([#1074](https://github.com/earthaccess-dev/earthaccess/issues/1074))
  ([@owenlittlejohns](https://github.com/owenlittlejohns))
- Populate search and access user guides.
  ([#1035](https://github.com/earthaccess-dev/earthaccess/pull/1035))
...
- Added `tenacity` to retry downloads up to 3 times with exponential backoff time, replaces #1016
  ([#481](https://github.com/earthaccess-dev/earthaccess/issues/481))
  ([@betolink](https://github.com/betolink))
- Add notebook demonstrating workflow with TEMPO Level 3 data as a virtual dataset
  ([#924](https://github.com/earthaccess-dev/earthaccess/pull/924))
...
- `get_s3_filesystem` now accepts an `endpoint` argument for specifying a credentials url.
  ([#602](https://github.com/earthaccess-dev/earthaccess/issues/602))
  ([@rwegener2](https://github.com/rwegener2))
- s3 `download` now checks for existing files.
  ([#807](https://github.com/earthaccess-dev/earthaccess/issues/807))
  ([@Sherwin-14](https://github.com/Sherwin-14))
- Added triaging guide ([#754](https://github.com/earthaccess-dev/earthaccess/issues/754))
  ([@Sherwin-14](https://github.com/Sherwin-14))
  ([@mfisher87](https://github.com/mfisher87))
- `download` now returns Path consistently.
  ([#595])(<https://github.com/earthaccess-dev/earthaccess/issues/595>)
  ([@Sherwin-14](https://github.com/Sherwin-14))
- Users may now authenticate with an existing Earthdata login token with
  environment variable `EARTHDATA_TOKEN`
  ([#484](https://github.com/earthaccess-dev/earthaccess/issues/484))
  ([@kgrimes2](https://github.com/kgrimes2))
- Added top level `status` function to check the statuses of NASA Earthdata services
  ([#161](https://github.com/earthaccess-dev/earthaccess/issues/161))
  ([@Sherwin-14](https://github.com/Sherwin-14))
...
- **Breaking:** Removed `has_granules=true` and `include_granule_counts=true`
  ...
  ([#884](https://github.com/earthaccess-dev/earthaccess/issues/884))
  ([@Sherwin-14](https://github.com/Sherwin-14))
- Python 3.10 is no longer supported.
  ([#966](https://github.com/earthaccess-dev/earthaccess/pull/966))
...
- Issue when `FileDistributionInformation` did not exist for a collection
  ([#971](https://github.com/earthaccess-dev/earthaccess/pull/971))
...
- `search_datasets` now accepts a `has_granules` keyword argument. Use
  ...
  ([#939](https://github.com/earthaccess-dev/earthaccess/issues/939))
...
- **Breaking**: earthaccess will now raise an exception when login credentials are
  ...
  ([#946](https://github.com/earthaccess-dev/earthaccess/pull/946))
...
- VirtualiZarr: earthaccess can open archival formats (NetCDF, HDF5) as if they were Zarr by leveraging VirtualiZarr
  ...
  See [example notebooks](https://github.com/earthaccess-dev/earthaccess/blob/v0.13.0/docs/tutorials/dmrpp-virtualizarr.ipynb)!
...
- `earthaccess.download` will let requests automatically decode compressed content
  ([#887](https://github.com/earthaccess-dev/earthaccess/issues/887))
...
- `earthaccess.download` now shares the authenticated session cookie among threads to avoid overloading EDL.
  ([#913](https://github.com/earthaccess-dev/earthaccess/issues/913))
...
- Use built-in `assert` statements instead of `unittest` assertions in
  integration tests ([#743](https://github.com/earthaccess-dev/earthaccess/issues/743))
...
- Add support for opening data files with virtualizarr and NASA dmrpp with `open_virtual_dataset`
  ([#605](https://github.com/earthaccess-dev/earthaccess/issues/605))
  ([@ayushnag](https://github.com/ayushnag))
- Add support for `NETRC` environment variable to override default `.netrc` file
  location ([#480](https://github.com/earthaccess-dev/earthaccess/issues/480))
  ([@chuckwondo](https://github.com/chuckwondo))
- Add `nox` session for running integration tests locally
  ([#815](https://github.com/earthaccess-dev/earthaccess/issues/815); [@chuckwondo](https://github.com/chuckwondo) and ([#872](https://github.com/earthaccess-dev/earthaccess/issues/872); [@jhkennedy](https://github.com/jhkennedy))
- Auto-add comment to PR that requires maintainer to review and re-run
  integration tests ([#824](https://github.com/earthaccess-dev/earthaccess/issues/824))
  ([@chuckwondo](https://github.com/chuckwondo))
...
- Python 3.9 is no longer supported.
  ([#876](https://github.com/earthaccess-dev/earthaccess/pull/876))
  ([@mfisher87](https://github.com/mfisher87))

### Fixed

- `earthaccess.download` will not ignore errors by default
  ([#581](https://github.com/earthaccess-dev/earthaccess/issues/581))
  ([**@Sherwin-14**](https://github.com/Sherwin-14),
  [**@chuckwondo**](https://github.com/chuckwondo),
  [**@mfisher87**](https://github.com/mfisher87))
- Integration tests no longer clobber existing `.netrc` file
  ([#806](https://github.com/earthaccess-dev/earthaccess/issues/806))
  (@chuckwondo)
- Return an empty list instead of raising an `IndexError` when searches find no results.
  ([#526](https://github.com/earthaccess-dev/earthaccess/issues/526))
  ([@jhkennedy](https://github.com/jhkennedy))
...
- Deprecate `earthaccess.get_s3fs_session` and `Store.get_s3fs_session`.  Use
  ...
  instead ([#766](https://github.com/earthaccess-dev/earthaccess/issues/766))
  ([@Sherwin-14](https://github.com/Sherwin-14),
  [@chuckwondo](https://github.com/chuckwondo))

### Added

- Add Issue Templates ([#281](https://github.com/earthaccess-dev/earthaccess/issues/281))
  ([@Sherwin-14](https://github.com/Sherwin-14))
- Support Service queries
  ([#447](https://github.com/earthaccess-dev/earthaccess/issues/447))
  ([@nikki-t](https://github.com/nikki-t),
  [@chuckwondo](https://github.com/chuckwondo),
  [@mfisher87](https://github.com/mfisher87),
  [@betolink](https://github.com/betolink))
- Add example PR links to pull request template
  ([#756](https://github.com/earthaccess-dev/earthaccess/issues/756))
  ([@Sherwin-14](https://github.com/Sherwin-14),
  [@mfisher87](https://github.com/mfisher87))
- Add Contributing Naming Convention document
  ([#532](https://github.com/earthaccess-dev/earthaccess/issues/532))
  ([@Sherwin-14](https://github.com/Sherwin-14),
  [@mfisher87](https://github.com/mfisher87))
...
- Remove `binder/` directory, as we no longer need a special
  ...
  [#733](https://github.com/earthaccess-dev/earthaccess/issues/733)
  ([@jhkennedy](https://github.com/jhkennedy))

### Fixed

- Remove broken link "Introduction to NASA earthaccess"
  ([#779](https://github.com/earthaccess-dev/earthaccess/issues/779))
  ([@Sherwin-14](https://github.com/Sherwin-14))
- Restore automation for tidying notebooks used in documentation
  ([#788](https://github.com/earthaccess-dev/earthaccess/issues/788))
  ([@itcarroll](https://github.com/itcarroll))
- Remove the base class on `EarthAccessFile` to fix method resolution
  ([#610](https://github.com/earthaccess-dev/earthaccess/issues/610))
  ([@itcarroll](https://github.com/itcarroll))
...
- Perform YAML formatting with `yamlfmt` instead of `prettier`
  ([#555](https://github.com/earthaccess-dev/earthaccess/issues/555))
  ([@chuckwondo](https://github.com/chuckwondo),
  [@mfisher87](https://github.com/mfisher87))
- Replace `print` calls with `logging` calls where appropriate and add T20 Ruff
  rule ([#511](https://github.com/earthaccess-dev/earthaccess/issues/511))
  ([@botanical](https://github.com/botanical),
  [@chuckwondo](https://github.com/chuckwondo),
  [@mfisher87](https://github.com/mfisher87))
- Update `CHANGELOG.md` to follow Common Changelog conventions
  ([#584](https://github.com/earthaccess-dev/earthaccess/pull/584))
  ([@danielfromearth](https://github.com/danielfromearth),
  [@chuckwondo](https://github.com/chuckwondo),
  [@jhkennedy](https://github.com/jhkennedy),
  [@mfisher87](https://github.com/mfisher87))
...
- Enable queries to Earthdata User Acceptance Testing (UAT) system for
  ...
  ([#421](https://github.com/earthaccess-dev/earthaccess/issues/421))
  ([@danielfromearth](https://github.com/danielfromearth),
  [@mfisher87](https://github.com/mfisher87),
  [@jhkennedy](https://github.com/jhkennedy),
  [@chuckwondo](https://github.com/chuckwondo),
...
- Add support for Python 3.12
  ([#457](https://github.com/earthaccess-dev/earthaccess/issues/457))
  ([@chuckwondo](https://github.com/chuckwondo),
  [@mfisher87](https://github.com/mfisher87))
- Added documentation for the backwards compatibility
  ([#471](https://github.com/earthaccess-dev/earthaccess/issues/471))
  ([@Sherwin-14](https://github.com/Sherwin-14),
  [@mfisher87](https://github.com/mfisher87))
...
- Use
  ...
  result sets ([#483](https://github.com/earthaccess-dev/earthaccess/issues/483))
...
- Correct and enhance static type hints for functions and methods that make CMR
  ...
  ([#508](https://github.com/earthaccess-dev/earthaccess/issues/508))
  ([@mfisher87](https://github.com/mfisher87),
  [@jhkennedy](https://github.com/jhkennedy),
  [@chuckwondo](https://github.com/chuckwondo),
  [@betolink](https://github.com/betolink))
- Create destination path prior to direct S3 downloads, if it doesn't already
  exist ([#562](https://github.com/earthaccess-dev/earthaccess/issues/562))
  ([@itcarroll](https://github.com/itcarroll),
  [@mfisher87](https://github.com/mfisher87),
  [@chuckwondo](https://github.com/chuckwondo))
- Fix broken image link in sea level rise tutorial
  ([#427](https://github.com/earthaccess-dev/earthaccess/issues/427))
...
- Add user-agent in the request to track usage
  ([#436](https://github.com/earthaccess-dev/earthaccess/issues/436))
  ([@asteiker](https://github.com/asteiker),
...
- Implement more trusted domains in the SessionWithRedirection
  ([#439](https://github.com/earthaccess-dev/earthaccess/issues/439))
  ([@cmspeed](https://github.com/cmspeed),
  [@mfisher87](https://github.com/mfisher87),
  [@betolink](https://github.com/betolink),
  [@jhkennedy](https://github.com/jhkennedy))
- Use an authenticated session for hits() instead of calling parent's class
  super() ([#438](https://github.com/earthaccess-dev/earthaccess/issues/438))
  ([@betolink](https://github.com/betolink),
  [@mfisher87](https://github.com/mfisher87),
  [@jhkennedy](https://github.com/jhkennedy))
...
- Update poetry lockfile
  ([#403](https://github.com/earthaccess-dev/earthaccess/pull/403))
  ([@jrbourbeau](https://github.com/jrbourbeau))
- Use YAML formatting (prettier)
  ([#398](https://github.com/earthaccess-dev/earthaccess/pull/398))
  ([@jrbourbeau](https://github.com/jrbourbeau))

### Added

- Add CI tests with minimum supported versions
  ([#402](https://github.com/earthaccess-dev/earthaccess/pull/402))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87),
  [@jhkennedy](https://github.com/jhkennedy))
- Add `python-dateutil` as a direct dependency
  ([#397](https://github.com/earthaccess-dev/earthaccess/pull/397))
  ([@jrbourbeau](https://github.com/jrbourbeau))

### Removed

- Remove binder PR comments
  ([#400](https://github.com/earthaccess-dev/earthaccess/pull/400))
  ([@jrbourbeau](https://github.com/jrbourbeau))

### Fixed

- Enable AWS check with IMDSv2
  ([#391](https://github.com/earthaccess-dev/earthaccess/pull/391))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87),
  [@itcarroll](https://github.com/itcarroll))
- Add region to running in AWS check
  ([#395](https://github.com/earthaccess-dev/earthaccess/pull/395))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@betolink](https://github.com/betolink))
- Handle opening multi-file granules
  ([#394](https://github.com/earthaccess-dev/earthaccess/pull/394))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@betolink](https://github.com/betolink))
...
- Handle S3 credential expiration more gracefully
  ([#354](https://github.com/earthaccess-dev/earthaccess/pull/354))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87))
- Use dependabot to update GitHub Actions
  ([#373](https://github.com/earthaccess-dev/earthaccess/pull/373))
  ([@jhkennedy](https://github.com/jhkennedy))
- Consolidate dependabot updates
  ([#380](https://github.com/earthaccess-dev/earthaccess/pull/380))
  ([@mfisher87](https://github.com/mfisher87))
- Switch to `ruff` for formatting
  ([#372](https://github.com/earthaccess-dev/earthaccess/pull/372))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87))
...
- Add `kerchunk` metadata consolidation utility
  ([#278](https://github.com/earthaccess-dev/earthaccess/pull/278))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87),
  [@betolink](https://github.com/betolink),
...
- Raise errors instead of `print`ing them in more cases
  ([#351](https://github.com/earthaccess-dev/earthaccess/pull/351))
  ([@jrbourbeau](https://github.com/jrbourbeau))
- `daac` and `provider` parameters are now normalized to uppercase, since
  lowercase characters are never valid
  ([#355](https://github.com/earthaccess-dev/earthaccess/pull/355))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87))
- Allow single file URL inputs for `earthaccess.download`
  ([#347](https://github.com/earthaccess-dev/earthaccess/pull/347))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87))
...
- Fix zero granules being reported for restricted datasets
  ([#358](https://github.com/earthaccess-dev/earthaccess/pull/358))
  ([@danielfromearth](https://github.com/danielfromearth))
...
- Treat granules without `RelatedUrls` as not cloud-hosted
  ([#339](https://github.com/earthaccess-dev/earthaccess/pull/339))
  ([@mfisher87](https://github.com/mfisher87))
...
- `earthaccess.download` now accepts a single granule as input in addition to a
  list of granules ([#317](https://github.com/earthaccess-dev/earthaccess/pull/317))
  ([@jrbourbeau](https://github.com/jrbourbeau))
- `earthaccess.download` now returns fully qualified local file paths
  ([#317](https://github.com/earthaccess-dev/earthaccess/pull/317))
  ([@jrbourbeau](https://github.com/jrbourbeau))
...
- Earthaccess will now automatically search for Earthdata authentication.
  ...
  ([#300](https://github.com/earthaccess-dev/earthaccess/pull/300))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87))
- Add `earthaccess.auth_environ()` utility for getting Earthdata authentication
  environment variables ([#316](https://github.com/earthaccess-dev/earthaccess/pull/316))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87))
...
- Fix spelling mistake in `access` variable assignment (`direc` -> `direct`) in
  ...
  ([#308](https://github.com/earthaccess-dev/earthaccess/pull/308))
...
- Return S3 data links by default when in region
  ([#318](https://github.com/earthaccess-dev/earthaccess/pull/318))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mfisher87](https://github.com/mfisher87),
  [@jhkennedy](https://github.com/jhkennedy))
...
- `earthaccess.get_s3fs_session()` can use the results to find the right set of
  S3 credentials ([#296](https://github.com/earthaccess-dev/earthaccess/pull/296))
  ([@betolink](https://github.com/betolink))

### Fixed

- `earthaccess.search_datasets()` and `earthaccess.search_data()` can find
  restricted datasets ([#296](https://github.com/earthaccess-dev/earthaccess/pull/296))
  ([@betolink](https://github.com/betolink))
- Fix distributed serialization for EarthAccessFile
  ...
  ([#276](https://github.com/earthaccess-dev/earthaccess/pull/276))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@betolink](https://github.com/betolink))
...
- Add download from onprem how-to
  ([#265](https://github.com/earthaccess-dev/earthaccess/pull/265))
  ([@andypbarrett](https://github.com/andypbarrett))

### Changed

- For CI, integration tests are now only run when we push to main (after a
  merge) ([#267](https://github.com/earthaccess-dev/earthaccess/pull/267))
  ([@betolink](https://github.com/betolink))
- For CI, unit tests are run for any branch and opened PR
  ([#267](https://github.com/earthaccess-dev/earthaccess/pull/267))
  ([@betolink](https://github.com/betolink))
- Update example in `search_datasets`
  ([#247](https://github.com/earthaccess-dev/earthaccess/pull/247))
  ([@jrbourbeau](https://github.com/jrbourbeau))
- Improve remote cluster performance
  ([#259](https://github.com/earthaccess-dev/earthaccess/pull/259))
  ([@jrbourbeau](https://github.com/jrbourbeau),
  [@mrocklin](https://github.com/mrocklin),
  [@mfisher87](https://github.com/mfisher87))
- Return useful error message for failed download
  ([#263](https://github.com/earthaccess-dev/earthaccess/pull/263))
  ([@andypbarrett](https://github.com/andypbarrett))
...
- Add exception handling for fsspec sessions, thanks to @jrbourbeau
  ([#249](https://github.com/earthaccess-dev/earthaccess/pull/249))
  ([@jrbourbeau](https://github.com/jrbourbeau))
...
- Remove Benedict (core dependency) as the default dict for JSON coming from CMR
  ...
  [#230](https://github.com/earthaccess-dev/earthaccess/issues/230))
...
- S3 credentials endpoints are tried with tokens and basic auth until all the
  ...
  ([#234](https://github.com/earthaccess-dev/earthaccess/pull/234))
  ([@betolink](https://github.com/betolink))
...
- For CI, documentation for readthedocs fixed by including poetry as the default
  tool ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214))
  ([@betolink](https://github.com/betolink))
- For CI, injected new secrets to test Auth using the icepyx convention
  (EARTHDATA_USERNAME) ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214))
...
- Add ability to get the user's profile with auth.user_profile which includes
  the user email ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214))
  ([@betolink](https://github.com/betolink))
- Add LAAD as a supported DAAC
  ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214))
  ([@betolink](https://github.com/betolink))

### Removed

- Remove magic from dependencies (not available in windows and not used but just
  in tests) ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214))
  ([@betolink](https://github.com/betolink))
...
- For CI, documentation is now only built for the main, dev and documentation
  branches ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202))
  ([@betolink](https://github.com/betolink))
- For CI, notebooks are executed every time the documentation gets published!
  ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202))
  ([@betolink](https://github.com/betolink),
  [@asteiker](https://github.com/asteiker))
...
- Raise and exception if a user specifies the netrc strategy and there is no
  netrc ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202))
  ([@betolink](https://github.com/betolink))
...
- Opening files using URLs was not working properly on AWS, thanks to @amfriesz
  for reporting it!  ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202))
  ([@betolink](https://github.com/betolink),
...
- Fix open() for direct access
  ([#186](https://github.com/earthaccess-dev/earthaccess/pull/186))
  ([@betolink](https://github.com/betolink))
...
- For CI, only run the publish workflow after a release on GitHub
  ([#183](https://github.com/earthaccess-dev/earthaccess/pull/183))
  ([@betolink](https://github.com/betolink))
...
- For CI, install Poetry using the new script
  ([#131](https://github.com/earthaccess-dev/earthaccess/pull/131))
  ([@betolink](https://github.com/betolink))
- For CI, change dependabot alerts to monthly
  ([#131](https://github.com/earthaccess-dev/earthaccess/pull/131))
  ([@betolink](https://github.com/betolink))
- Improve documentation by reimplementing python_cmr methods for docstring
  compatibility ([#131](https://github.com/earthaccess-dev/earthaccess/pull/131))
  ([@betolink](https://github.com/betolink))
- Use `CMR-Search-After`
  ([#145](https://github.com/earthaccess-dev/earthaccess/issues/145))
  ([@betolink](https://github.com/betolink))
...
- Add store, auth to docs and update mkdocs config
  ([#119](https://github.com/earthaccess-dev/earthaccess/pull/119))
  ([@betolink](https://github.com/betolink))
...
- For `store`, use fsspec s3fs for in cloud access and https sessions for out of
  region access ([#43](https://github.com/earthaccess-dev/earthaccess/issues/43))
  ([@betolink](https://github.com/betolink))
- For `store`, can open files with fsspec in and out of region (stream into
  xarray) ([#41](https://github.com/earthaccess-dev/earthaccess/issues/41))
  ([@betolink](https://github.com/betolink))
...
- Update python-cmr to NASA fork
  ([#75](https://github.com/earthaccess-dev/earthaccess/pull/75))
  ([@jhkennedy](https://github.com/jhkennedy))
- Drop unused `pydantic` dependency
  ([`5761548`](https://github.com/earthaccess-dev/earthaccess/pull/75/commits/5761548fcd8ba8733ce4f5ff9b8ce7967c3a8398))
  ([@jhkennedy](https://github.com/jhkennedy))
- Auth can refresh CMR tokens
  ([#82](https://github.com/earthaccess-dev/earthaccess/pull/82))
  ([@betolink](https://github.com/betolink))
...
- Add missing `python-datutil` dependency
  ([`747e992`](https://github.com/earthaccess-dev/earthaccess/pull/75/commits/747e9926a5ab83d75bbf7f17d4c52f24b563147b))
  ([@jhkennedy](https://github.com/jhkennedy))
...
- Fix store to download multi-file granules
  ([#73](https://github.com/earthaccess-dev/earthaccess/pull/73))
  ([@betolink](https://github.com/betolink))
- Fix granule formatting ([#73](https://github.com/earthaccess-dev/earthaccess/pull/73))
  ([@betolink](https://github.com/betolink))
...
- Rename Accessor to Store
  ([`4bd618d`](https://github.com/earthaccess-dev/earthaccess/pull/66/commits/4bd618d4d48c3cd256a077fb8329f40df2d5b7ff))
  ([@betolink](https://github.com/betolink))
- Relax dependency requirements
  ([`c9a5ed6`](https://github.com/earthaccess-dev/earthaccess/pull/66/commits/c9a5ed6b917435e7c4ece58485939065fa71cc8f))
  ([@betolink](https://github.com/betolink))
- Store can download plain links if they are on prem
  ([`92d2919`](https://github.com/earthaccess-dev/earthaccess/commit/92d291962e5b72b458c2971eae8a6b813d4bae39))
  ([@betolink](https://github.com/betolink))
